...
#endif /* OPLUS_FEATURE_DISPLAY */
#if defined(CONFIG_PXLW_IRIS)
	"qcom,mdss-dsi-iris-switch-panel-te-scanline-command",
#endif
};
...
#endif /* OPLUS_FEATURE_DISPLAY */
#if defined(CONFIG_PXLW_IRIS)
	"qcom,mdss-dsi-iris-switch-panel-te-scanline-command-state",
#endif
};
...
int dsi_panel_switch(struct dsi_panel *panel)
{
	...
	if (iris_is_chip_supported() && iris_is_pt_mode(panel)) {
		...
		DSI_INFO("dsi_cmd %s\n", cmd_set_prop_map[DSI_CMD_SET_TIMING_SWITCH]);
	} else
#endif
