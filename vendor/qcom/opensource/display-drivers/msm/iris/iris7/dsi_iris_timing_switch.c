...
#define TSP_VSYNC_CMD_COUNT 2
#define TSP_VSYNC_CMD_DATA_COUNT 12
void iris_send_panel_te_scanline_cmd(bool enable)
{
	int rc = 0;
	int i = 0;
	struct iris_cfg *pcfg = iris_get_cfg();
	...
	u8 cmd_data[TSP_VSYNC_CMD_COUNT][TSP_VSYNC_CMD_DATA_COUNT] = {
		{0x39, 0x00, 0x00, 0x40, 0x00, 0x00, 0x05, 0x35, 0x00, 0x00, 0x00, 0x00},
		{0x39, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x44, 0x00, 0x00}
	};
