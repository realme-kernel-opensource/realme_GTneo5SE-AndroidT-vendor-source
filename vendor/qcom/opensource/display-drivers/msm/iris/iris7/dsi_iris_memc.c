...
void iris_memc_ctrl_cmd_proc(u32 cmd)
{
	...
	case MEMC_CTRL_VFR_DISABLE:
		...
		break;
	case MEMC_CTRL_ADJUST_TE_SCANLINE:
		iris_send_panel_te_scanline_cmd(true);
		IRIS_LOGI("MEMC_CTRL_PANEL_ADJUST_TE_SCANLINE");
		break;
	case MEMC_CTRL_RESET_TE_SCANLINE:
		iris_send_panel_te_scanline_cmd(false);
		IRIS_LOGI("MEMC_CTRL_PANEL_RESET_TE_SCANLINE");
		break;
