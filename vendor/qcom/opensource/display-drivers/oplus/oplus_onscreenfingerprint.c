...
int oplus_ofp_init(void *dsi_panel)
{
	...
	if ((!strcmp(panel->panel_of_node->name, "qcom,mdss_dsi_oplus_senna_bc_nt37705_1240_2772_dsc_cmd_evt")) ||
		(!strcmp(panel->panel_of_node->name, "qcom,mdss_dsi_oplus_senna_bc_nt37705_1240_2772_dsc_cmd")) ||
		(!strcmp(panel->panel_of_node->name, "qcom,mdss_dsi_oplus_senna_bc_nt37705_1240_2772_dsc_cmd_04")) ||
		(!strcmp(panel->panel_of_node->name, "qcom,mdss_dsi_oplus_senna22623_nt37705_1240_2772_dsc_cmd_04")) ||
		(!strcmp(panel->panel_of_node->name, "qcom,mdss_dsi_oplus_senna22623_nt37705_1240_2772_dsc_cmd_evt")) ||
		(!strcmp(panel->panel_of_node->name, "qcom,mdss_dsi_oplus_senna22623_nt37705_1240_2772_dsc_cmd"))) {
